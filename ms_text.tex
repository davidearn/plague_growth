...
\leftline{plague $|$ London $|$ epidemic growth rate}
...
\\ \vspace{0.5cm}
\includegraphics[width=\textwidth]{analysis/plots/plot_all.pdf}
%% \includegraphics[width=\textwidth]{plot_all.eps}
\end{center}
\vspace{-0.5cm}
\caption[]{
...
\begin{center}
  ...
  \input{analysis/tables/fakeparams.tex}
