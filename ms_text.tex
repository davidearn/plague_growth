...
\\ \vspace{0.5cm}
\includegraphics[width=\textwidth]{analysis/plots/plot_all.Routpdf}
...
%%
\david{I meant that if CFP$=1$ then all infected individuals get
  detected by mortality statistics, hence this would yield larger
  observed attack rate than if CFP$<1$.  Not sure this is
  sufficiently clear.}
